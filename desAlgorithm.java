...
class desAlgorithm {
    ...
    public static void main(String args[]) {
        ...
        for(int i = 0; i < 32; i++) {
            ...
            if(flag) i--; else straightPermutation[i] = temp;
        }
        ...
        for(int i = 0; i < 8; i++) for(int j = 0; j < 4; j++) for(int k = 0; k < 16; k++) {
                    ...
                    if(flag) k--; else substBox[i][j][k] = temp;
                }
        String text = "A123B45C6D78E90F";
        String key = "01234ABCDEF56789";
        DES cipher = new DES();
